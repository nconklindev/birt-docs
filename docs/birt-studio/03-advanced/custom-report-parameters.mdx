...
All [filter conditions](/docs/birt-studio/getting-started/filtering#filter-conditions) are described in another article if you are unsure of how each one works.
